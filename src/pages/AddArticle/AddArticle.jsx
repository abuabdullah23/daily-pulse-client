                ...
                <div className='flex flex-col gap-5'>
                    ...
                    <div className='flex flex-col md:flex-row gap-4'>
                        <div className='flex flex-col items-start gap-1 w-full'>
                            ...
                            <textarea required type="text" name='description' placeholder='Write your article description' className='w-full py-2 px-2 border bg-transparent border-indigo-400 focus:border-indigo-500 rounded outline-none' />
                        </div>
                    </div>
