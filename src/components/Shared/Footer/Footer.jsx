...
const Footer = () => {
    return (
        <div>
            <footer className="divide-y dark:bg-[#000000] bg-gray-300 dark:text-gray-100 mt-16">
                <Container>
                    <div className="flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                        <div className="lg:w-1/3">
                            <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                                <div className="flex p-2.5 items-center justify-center w-12 h-12 rounded-full bg-[#14213d] dark:bg-transparent">
                                   <img src={smallLogoDark} alt="logo" />
                                </div>
                        ...
                        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                            <div className="space-y-3">
                                <h3 className="tracki uppercase dark:text-gray-50">News</h3>
                                <ul className="space-y-1">
                                    <li>
                                        <Link rel="noopener noreferrer" to={'/premium-articles'} >Premium</Link>
                                    </li>
                            ...
                            <div className="space-y-3">
                                <h3 className="uppercase dark:text-gray-50">Authors</h3>
                                <ul className="space-y-1">
                                    <li>
                                        <Link rel="noopener noreferrer" to={'/add-article'}>Add Article</Link>
                                    </li>
                                    <li>
                                        <Link rel="noopener noreferrer" to={'/my-articles'}>My Articles</Link>
                                    </li>
                                </ul>
                            </div>
                            <div className="space-y-3">
                ...
                <div className="py-4 text-sm text-center text-gray-700 dark:text-gray-300 bg-gray-300 dark:bg-[#14213d]">© 2024 <Link to='https://daily-pulse-client.web.app'>Daily Pulse</Link>. All rights reserved.</div>
            </footer>
        </div>
    );
};
